...
@SuiteClasses({DBControllerTest.class,DriverTest.class,StudentFunctionalityControllerTest.class,StudentInteractionTest.class,
	...
	UserInteractionTest.class,UserTest.class,LoginTest.class,LogoutTest.class, TopFiveRecpmmendedSchoolsTest.class, ViewUserListTest.class, ActivateAndDeactivateTest.class, EditProfileTest.class})
